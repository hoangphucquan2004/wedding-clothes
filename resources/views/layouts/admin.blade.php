                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme01">
                                    <img src="{{ '../../assets/admin/images/demo/default.png' }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme02">
                                    <img src="{{ '../../assets/admin/images/demo/saas.png' }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme03">
                                    <img src="{{ '../../assets/admin/images/demo/corporate.png' }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme04">
                                    <img src="{{ '../../assets/admin/images/demo/galaxy.png' }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme05">
                                    <img src="{{ '../../assets/admin/images/demo/material.png' }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme06">
                                    <img src="{{ '../../assets/admin/images/demo/creative.png' }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme07">
                                    <img src="{{ '../../assets/admin/images/demo/minimal.png' }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme08">
                                    <img src="{{ '../../assets/admin/images/demo/modern.png' }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme09">
                                    <img src="{{ '../../assets/admin/images/demo/interactive.png' }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme10">
                                    <img src="{{ '../../assets/admin/images/demo/classic.png' }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme11">
                                    <img src="{{ '../../assets/admin/images/demo/vintage.png' }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
