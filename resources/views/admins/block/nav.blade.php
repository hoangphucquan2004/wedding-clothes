                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.danhmucs.index') }}" class="nav-link" data-key="t-chat">
                                    Danh mục
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.sanphams.index') }}" class="nav-link" data-key="t-chat"> Sản
                                    phẩm </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarCrypto">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.danhmuc_baiviets.index') }}" class="nav-link"
                                    data-key="t-chat">
                                    Danh mục Bài Viết
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.baiviets.index') }}" class="nav-link" data-key="t-chat"> Bài
                                    Viết </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarInvoices">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.lienhes.index') }}" class="nav-link" data-key="t-chat">
                                    Danh Sách Liên Hệ
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="collapse menu-dropdown" id="sidebarAuth">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.accouts.index') }}" class="nav-link" data-key="t-basic">
                                            Danh Sách Tài Khoản
                                        </a>
                                    </li>
                                </ul>
